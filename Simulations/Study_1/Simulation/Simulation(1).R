################################################################################
# File:         Simulation(1).R
# Description:  Monte Carlo simulation for Study 1 (3-factor model with 3
...
#               types = 144 conditions). Estimates via LMS, QML, UPI, and LSAM.
# Dependencies: lavaan, modsem, doParallel, doRNG, covsim, rvinecopulib
# Sources:      Models(1).R, Methods.R, GenerateData.R
# Output:       Simulations/Study_1/Data/
